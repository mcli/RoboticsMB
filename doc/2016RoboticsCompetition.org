...
** Relay
   ...
   8. Only the active robot and the robot for the next segment shall be powered on.
   9. Segment shall be considered complete when hand-off is complete, or
      in the case of segment 7, the finish line is crossed.
   10. Segments 3 and 5, the participant may optionally place one stationary 
